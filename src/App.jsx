...
function App() {
  ...
  const randomImg = [
    ...
    "urlhttps://img.freepik.com/vector-gratis/diseno-fondo-abstracto-blanco_23-2148825582.jpg?w=740&t=st=1671485317~exp=1671485917~hmac=5e180053164389d0904bb81981783dd3ea359b0d66aacd0ea3507a3111e0f1e8",
  ]
  ...
  // document.body.style = `fontSize: ${size[shuffleSize]}`;
  // document.body.style = `backgroundImage: ${randomImg[shuffleImg]}`;
  // const titleQuote = document.getElementsByTagName("h3")
  // titleQuote.style = `color: ${colors[shuffleColor]}`;
...
// font-family: 'Sono', sans-serif'`,
  ...
  // container.body.appendChild(titleQuote);
  // container.body.appendChild(titleQuote);
  // document.body.appendChild(titleQuote);
  // document.body.appendChild(authorQuote);
